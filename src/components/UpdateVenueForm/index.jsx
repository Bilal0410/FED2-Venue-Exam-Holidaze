      ...
      <div className="bg-white p-4 rounded-md shadow-md w-full max-w-md h-full max-h-screen overflow-y-auto">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end">
            ...
            <button
              type="submit"
              className="ml-4 inline-flex justify-center rounded-md border border-transparent bg-red-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2"
            >
              Update Venue
            </button>
          </div>
